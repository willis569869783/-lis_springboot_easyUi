...
$(function(){
	$("#dg").datagrid({
	idField:"id",
	url:"ClassesListen/queryByViewPage",
	fitColumns:true,
	fit:true,
	columns:[[  
		{field:'',checkbox:true},
        {field:'classesName',title:'试听班级名称',width:100,align:'center'},
        {field:'majorName',title:'试听专业',width:100,align:'center'},
        {field:'managerName',title:'班主任',width:100,align:'center'},
        {field:'teacherName',title:'代课老师',width:50,align:'center'},
        {field:'classesRoom',title:'教室名称',width:100,align:'center'},
        {field:'beginDate',title:'试听开始时间',width:150,align:'center'},
        {field:'endDate',title:'试听结束时间',width:150,align:'center'},
