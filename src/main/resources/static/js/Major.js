...
$(function(){
	$("#dg").datagrid({
	idField:"id",
	url:"Major/queryByPage",
	fitColumns:true,
	fit:true,
	columns:[[  
		{field:'',checkbox:true},  
        {field:'name',title:'专业名称',width:100,align:'center'},    
        {field:'manager',title:'专业负责人',width:100,align:'center'},
        {field:'remark',title:'专业描述',width:100,align:'center'},
        {field:'beginDate',title:'创建时间',width:150,align:'center'}
    ]],
    pagination:true,
    pageSize:20,
    scrollbarSize:0,
