...
$(function(){
	...
	columns:[[  
        ...
        {field:'roomTotalSize',title:'容纳人数',width:100,align:'center'},
        {field:'roomEmptySize',title:'空余床位',width:100,align:'center'},
        {field:'roomPersonSex',title:'住宿人性别',width:100,align:'center',formatter: function(value,row,index){
			if (value==1){
				return "男";
			} else {
				return "女";
        ...
        {field:'roomMoney',title:'每月住宿费',width:100,align:'center'},
        {field:'roomDeposit',title:'房间押金',width:100,align:'center'},
        {field:'roomManager',title:'房东',width:100,align:'center'},
