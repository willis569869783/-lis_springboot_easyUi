...
<html>
	...
	<head>
		...
		<script src="js/ClassesStudy.js" type="text/javascript" charset="utf-8"></script>
	</head>
				...
				<input type="hidden" name="classesId" id="classesId" value="0" />
					<table class="center">
						...
						<tr>
							<td>班主任:</td>
							<td>
								<select id="manager" name="managerid"></select>
							</td>
						</tr>
						<tr>
							<td>代课老师:</td>
							<td><select id="teacher" name="teacherid"></select></td>
						</tr>
						<tr>
							<td>教室名称:</td>
						...
						<tr>
							<td>最后一次合班日期:</td>
							<td><input class="easyui-datebox" type="date" id="lastJoinDate" name="lastJoinDate" data-options="required:true" /></td>
						</tr>
						<tr>
							<td>合班次数:</td>
							<td><input class="easyui-textbox" type="text" id="joinCount" name="joinCount" data-options="required:true" /></td>
						</tr>
						<tr>
							<td>结束时间:</td>
						...
						<tr>
							<td>最后结束时间:</td>
							<td><input class="easyui-datebox" type="date" id="lastEndDate" name="lastEndDate" data-options="required:true" /></td>
						</tr>
					</table>
					<div id="bb">
